...
var RS_CacheGS = window.#faae8aSockGlobals, RS_CacheGS_queue = window._gsQueue,RS_Cache_define = window._gsDefine; window._gsDefine = null;delete window._gsDefine;var punchgs = window.#faae8aSockGlobals = {};
...
try{
	window.#faae8aSockGlobals = null;
	window._gsQueue = null;
	window._gsDefine = null;
	delete(window.#faae8aSockGlobals);
	delete(window._gsQueue);
	delete(window._gsDefine);	
   } catch(e) {}

try{
	window.#faae8aSockGlobals = RS_CacheGS;
